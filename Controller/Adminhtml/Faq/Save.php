...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \BuyRite\Faq\Model\Faq $model */
            $model = $this->_objectManager->create('BuyRite\Faq\Model\Faq')->load($id);
    ...
    {
        if ($this->_authorization->isAllowed('BuyRite_Faq::faq_edit') || $this->_authorization->isAllowed('BuyRite_Faq::faq_create')) {
            return true;
        }
        return false;
    }
