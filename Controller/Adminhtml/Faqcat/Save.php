...
namespace BuyRite\Faq\Controller\Adminhtml\Faqcat;

use Magento\Backend\App\Action\Context;
use Magento\Framework\Exception\LocalizedException;
use Magento\TestFramework\Inspection\Exception;
use BuyRite\Faq\Model\ResourceModel\Faqcat;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \BuyRite\Faq\Model\Faqcat $model */
            $model = $this->_objectManager->create('BuyRite\Faq\Model\Faqcat')->load($id);
    ...
    {
        if ($this->_authorization->isAllowed('BuyRite_Faq::category_create') || $this->_authorization->isAllowed('BuyRite_Faq::category_edit')) {
            return true;
        }
        return false;
    }
