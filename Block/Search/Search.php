...
namespace BuyRite\Faq\Block\Search;

use Magento\Framework\View\Element\Template\Context;
use BuyRite\Faq\Helper\Question as QuestionHelper;
...
{
    /**
     * @var \BuyRite\Faq\Helper\Question
     */
    ...
    public function getFaqsList()
    {
        $select = $this->_faqResourceModel->getConnection()->select()
            ...
            ->joinLeft(
                ['faq_store' => $this->_faqResourceModel->getTable('buyrite_faq_store')],
