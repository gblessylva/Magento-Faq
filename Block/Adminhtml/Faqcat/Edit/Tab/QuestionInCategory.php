...
class QuestionInCategory extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \BuyRite\Faq\Model\Faq $faqModel,
    ...
    protected function _prepareCollection()
    {
        ...
        if ($category_id = $this->getRequest()->getParam('category_id')) {
            $collection->getSelect()->join(['fcat' => 'buyrite_faq_category_id'], 'main_table.faq_id = fcat.faq_id', ['category_id'])->where('fcat.category_id =?', (int) $category_id);
        }
