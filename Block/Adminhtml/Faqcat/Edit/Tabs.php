    ...
    protected function _prepareLayout()
    {
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock('BuyRite\Faq\Block\Adminhtml\Faqcat\Edit\Tab\General')->toHtml()
            ]
        );
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock('BuyRite\Faq\Block\Adminhtml\Faqcat\Edit\Tab\SearchEngineOptimisation')->toHtml()
            ]
        );
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock('BuyRite\Faq\Block\Adminhtml\Faqcat\Edit\Tab\Websites')->toHtml()
            ]
        );
